...
! function (t) {
	t.fn.cornerpopup = function (e) {
		...
		cp = "#corner-popup", t(cp).length && (t(cp).remove(), console.info("Corner Popup already initialized")), 0 != e.active && (t("<div/>", {
			...
			left: "0"
		})), 0 !== e.timeOut && (o = e.timeOut, setTimeout(function () {
			0 == e.slide ? t(cp).fadeOut(400, function () {
				t(this).remove(), e.afterPopup.call(this)
			}) : c()
		}, o)), t(".corner-close").click(function () {
			n()
		}), t(".corner-btn, .corner-btn-close, .corner-btn-cookie").click(function (o) {
			elementClassName = t(this).attr("class"), 13 < e.onBtnClick.toString().length ? (o.preventDefault(), e.onBtnClick.call(this)) : "corner-btn-cookie" == elementClassName ? (n(), function (o, e, n) {
				var c = new Date;
				c.setTime(c.getTime() + 24 * n * 60 * 60 * 1e3);
				var t = "; expires=" + c.toGMTString();
				document.cookie = o + "=" + e + t + "; path=/"
			}("cp-cookies-accepted", "Yes", 365)) : "corner-btn-close" == elementClassName && "#" == e.link2[0] && n()
		}), t(document).keyup(function (o) {
			0 == e.escClose || "Escape" !== o.key && 27 != o.keyCode || n()
		}), t.fn.cornerpopup.popupClose = function (o) {
			setTimeout(n, o)
		}, t.fn.cornerpopup.popupHide = function (o) {
			t(cp).delay(o).fadeOut(400)
		}, t.fn.cornerpopup.popupShow = function (o) {
