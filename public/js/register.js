...
$(document).ready(function () {
    ...
    function autocompleteDC(inp, tmpParam, arr) {
    ...
    autocompleteDC(document.getElementById("reg-district"), 0, districts);
    autocompleteDC(document.getElementById("reg-hometown"), 1, cities);
