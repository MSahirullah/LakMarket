...
<script>
    ...
    function showResult(products) {
        ...
        $.each(products, function(index, value) {
            ...
            x.innerHTML += '<div class="search-tile-hr"><div class="row search-tile-body search-product menu-product"><div class="col-md-c-3"> ' + discount + '' + stock + '<div class="image-container"><a href="/product/' + value.url + '"><img src="/' + image + '"  alt="' + imageAlt + '" class="home-tile-img p-0"></a></div><div class="product-rating-div-search"><i class="fas fa-star rating-star-icon"></i><span class="rating-value">(' + rating + ')</span></div></div><div class="home-tile-title col-md-7"><a href="/product/' + value.url + '" class="home-tile-title-h price-tile">' + name + '</a><div class="product-desc"><div class="shor-desc">' + value.short_desc + '</div><div class="long-desc">' + long_desc + '</div></div><div class="shop-name"><a target="_blank" href="/store/' + value.sellerURL + '">' + value.seller + '</a></div><div class="district-city"><span class="district">' + value.district + '</span><span">, </span><span class="city">' + value.city + '</span></div></div><div class="col-md-c-2  text-center"><div class="home-tile-price pt-10"><p class="home-tile-price-rs">Rs. <span class="home-tile-price">' + price + '</span></p><div class="product-price">' + unitP + '</div></div><div class="option-btn" style="display:none;"><button style="margin: 0px 8px 0px 7px;"><i class="fas fa-heart"></i></button><button style="margin: 0px 5px 0px 10px"><i class="fas fa-cart-plus"></i></button></div><div class="by-now-btn"><button>Buy Now</button></div></div></div></div>';
        });
