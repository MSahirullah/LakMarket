            ...
            <div class="row">
                <div class="filter-col">
                    ...
                    <div class="filter-item" style="border-bottom:unset;">
                        <div class="filter-item-body">
                            <p class="filter-title-text">Related Categories</p>
                            <div class="filter-related-cato">
                                ...
                                <li class="f-r-c-li-ii"><a href="#">Cato 03-01</a></li>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="result-col">
                    ...
                    <div class="search-tile-title">
                        <h4>Related shops for "<span>light</span>"</h4>
                    </div>
                    <div class="search-tile-div owl-carousel owl-theme owl-c-4 owl-c-4-1">
