            ...
            <div class="row">
                    ...
                    <div class="filter-item" style="border-bottom:unset;">
                        <div class="filter-item-body">
                            ...
                            <div class="filter-related-cato">
                                ...
                                <li class="f-r-c-li-ii">
                                    <a class="selected-sc" href="#">Novels</a>
                                </li>
                ...
                <div class="result-col">
                    <div class="result-count">
                        <div>
                            <h5> <b><span>3550</span></b> items found in <b>"<span>Novels</span>"</b></h5>
                        </div>
                    ...
                    <div class="search-tile-title">
                        <h4>Shops for "<span>Novels</span>"</h4>
                    </div>
                    <div class="search-tile-div owl-carousel owl-theme owl-c-5">
                        @for ($i = 0; $i < 4; $i++) <div class="col-md home-tile">
                            <div class="home-tile-body">
                                ...
                                <div class="search-tile-button">
                                    <a href="#" class="search-tile-visit"><i class="fas fa-shopping-cart shop-icon"></i>Visit</a>
                                    <a href="#" class="search-tile-get-direction"><i class="fas fa-directions direction-icon"></i>Direction</a>
                                </div>
                            </div>
                    </div>
                    @endfor
                ...
                <div class="search-tile-title" style="margin-bottom: 15px;">
                    <h4>Products for "<span>Novels</span>"</h4>
                </div>
...
@section('scripts')
<script src="{{ asset('js/sub-categories.js') }}" defer></script>
@endsection